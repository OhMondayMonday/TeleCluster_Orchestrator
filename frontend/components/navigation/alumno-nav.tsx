...
import { LogOut, Layers, Settings } from "lucide-react"
import { cn } from "@/lib/utils"

const navigation = [
  { name: "Mis Slices", href: "/alumno/slices", icon: Layers },
  { name: "Configuración", href: "/alumno/settings", icon: Settings },
]
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/alumno/slices" className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                ...
                <div className="text-xs text-white/70">Portal de Estudiantes</div>
              </div>
            </Link>
